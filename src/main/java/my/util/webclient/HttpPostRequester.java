...
public class HttpPostRequester implements HttpRequester {
    ...
    @Override
    public HttpResult submit(String url, Map<String, String> parameters, Map<String, String> customHeaders, int timeout) throws Exception {
        CloseableHttpClient httpclient = HttpClients.createDefault();
        HttpResult httpResult = new HttpResult();
        try {
            HttpPost post = new HttpPost(url);
            ...
            if (null != parameters && parameters.size() > 0){
                ...
                for(String key : keys){
                    ...
                    logger.debug("add key[{}]-value[{}] to parameters"
